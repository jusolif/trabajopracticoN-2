...
if modulo == "Home":
    ...
    st.markdown("""
    **1. Aceptación de la campaña**

    La aceptación de la campaña fue relativamente baja, ya que solo el 11.27% 
    de los clientes aceptó la propuesta, mientras que el 88.73% no lo hizo. 
    Esto muestra una oportunidad de mejora en la estrategia comercial, 
    especialmente en la segmentación y selección de los clientes contactados.
    """)
